...
pub async fn reload_config_impl<PM: config::ProjectsManager>(
...
pub async fn reload_project_impl<PM: config::ProjectsManager>(
    call_context: CallContext<PM>,
    project_id: String,
) -> Result<ReloadResult, anyhow::Error> {
    todo!()
...
pub async fn trigger_projects_impl<PM: config::ProjectsManager>(
    call_context: CallContext<PM>,
    event: ActionEvent,
) {
    todo!()
